...
import json
import os
from persona_com_instruct_generate_demo_lima_persona2_test import random_sample
import vllm
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        # required=True,
        default="/home/dyf/data_generate/doc-instruct/data/lima/epoch/diff/diff_new_instruct_100000_doc_round_0_Llama-3.1-Tulu-3-8B.jsonl",
